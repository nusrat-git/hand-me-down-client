            ...
            <main>
                <div className="relative px-6 lg:px-8">
                    <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
                        <div>
                            <div>
                                <h1 className="text-4xl font-bold text-white tracking-tight sm:text-center sm:text-6xl">
                                    You are lost in the forest
                                </h1>
                                <p className="mt-6 text-3xl leading-8 sm:text-center text-white">
                                    Looks like you have come to the forest in search of furniture
                                </p>
