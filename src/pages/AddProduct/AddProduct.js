    ...
    return (
        <div>
            <div className=' my-10 md:flex items-center w-fit mx-auto border rounded-2xl'>
                <div className='py-10'>
                    ...
                    <form className=' px-20' onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-6">
                            ...
                            <input type="text" {...register("category")} id="category" className="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-[400px] p-2.5" required />
                        </div>
                        <div className="mb-6">
                            <label htmlFor="product" className="block mb-2 text-sm font-medium text-gray-600 text-start ml-3">Product </label>
                            <input type="text" {...register("product")} id="product" className="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-[400px] p-2.5" required />
                        </div>
                        <div className="mb-6">
                        ...
                        <div className="mb-6">
                            ...
                            <input type="text" {...register("location")} id="location" className="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-[400px] p-2.5 " required />
                        </div>
                        <div className="mb-6">
                            <label htmlFor="resale_price" className="block mb-2 text-sm font-medium text-gray-600 text-start ml-3">Resale Price</label>
                            <input type="number" {...register("resale_price")} id="resale_price" className="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-[400px] p-2.5 " required />
                        </div>
                        <div className="mb-6">
                            <label htmlFor="original_price" className="block mb-2 text-sm font-medium text-gray-600 text-start ml-3">Original Price</label>
                            <input type="number" {...register("original_price")} id="original_price" className="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-[400px] p-2.5 " required />
                        </div>
                        <div className="mb-6">
                            <label htmlFor="use_period" className="block mb-2 text-sm font-medium text-gray-600 text-start ml-3">Use Period</label>
                            <input type="text" {...register("use_period")} id="use_period" className="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-[400px] p-2.5 " required />
                        </div>
                        <div className="mb-6">
                            <label htmlFor="seller_name" className="block mb-2 text-sm font-medium text-gray-600 text-start ml-3">Seller </label>
                            <input type="text" {...register("seller_name")} id="seller_name" className="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-[400px] p-2.5 " required />
                        </div>
                ...
                <img src={product} alt="sofa" className='md:h-[600px] rounded-tr-xl rounded-br-xl' />
                <Toaster />
            </div>
        </div>
    );
